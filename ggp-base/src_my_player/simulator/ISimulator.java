...
public interface ISimulator extends Subject {
	...
	class SimulatorEvent extends Event {
		...
		public final Collection<LabeledState> labeledStates;
		public final int discoveredStates;

		public SimulatorEvent(Set<GdlSentence> contents,
				Collection<LabeledState> labeledStates, int discoveredStates) {
